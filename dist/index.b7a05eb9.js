...
var _ux = require("./modules/ux");
var _memberhandling = require("./modules/memberhandling");
var _taskshandling = require("./modules/taskshandling");
var _log = require("./modules/log");
//------------------------------------------------
const memberHandler = new (0, _memberhandling.MemberHandler)();
const taskHandler = new (0, _taskshandling.TaskHandler)();
(0, _firebase.initializeFirebase)();
(0, _ux.initializeUI)();
memberHandler.listenForMembers((0, _ux.updateMembersUI));
taskHandler.listenForTasks((0, _ux.updateTasksUI));
(0, _ux.populateAssignMenu)();
(0, _ux.setupAssignMenu)();
(0, _ux.setupFormSubmission)();
(0, _ux.setupResetButton)();
(0, _ux.setupDeleteButton)();
(0, _ux.setupDoneButton)();
(0, _ux.setupFiltering)();
(0, _ux.setupDynamicFilters)();
(0, _log.startLogging)(); //-------------------------------------

},{"./modules/firebase":"2cuXI","./modules/ux":"7yXbs","./modules/memberhandling":"5TK2Q","./modules/taskshandling":"brsxg","./modules/log":"ggIi6"}],"2cuXI":[function(require,module,exports,__globalThis) {
...
function initializeFirebase() {
    const usersRef = (0, _database.ref)(db, "/users");
...
},{"6b38617303e2f7b9":"d5jf4","@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7yXbs":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setupDropdown", ()=>setupDropdown);
parcelHelpers.export(exports, "setupFormValidation", ()=>setupFormValidation);
parcelHelpers.export(exports, "initializeUI", ()=>initializeUI);
parcelHelpers.export(exports, "setupAssignMenu", ()=>setupAssignMenu);
parcelHelpers.export(exports, "setupOptionsMenu", ()=>setupOptionsMenu);
parcelHelpers.export(exports, "setupFormSubmission", ()=>setupFormSubmission);
parcelHelpers.export(exports, "getSelectedDropdownValues", ()=>getSelectedDropdownValues);
parcelHelpers.export(exports, "setupResetButton", ()=>setupResetButton);
parcelHelpers.export(exports, "updateMembersUI", ()=>updateMembersUI);
parcelHelpers.export(exports, "updateTasksUI", ()=>updateTasksUI);
parcelHelpers.export(exports, "setupDeleteButton", ()=>setupDeleteButton);
parcelHelpers.export(exports, "setupDoneButton", ()=>setupDoneButton);
parcelHelpers.export(exports, "assignSelectedTaskToMember", ()=>assignSelectedTaskToMember);
parcelHelpers.export(exports, "populateAssignMenu", ()=>populateAssignMenu);
parcelHelpers.export(exports, "setupFiltering", ()=>setupFiltering);
parcelHelpers.export(exports, "filterTasks", ()=>filterTasks);
parcelHelpers.export(exports, "setupDynamicFilters", ()=>setupDynamicFilters);
parcelHelpers.export(exports, "setupCategoryFilter", ()=>setupCategoryFilter);
parcelHelpers.export(exports, "enforceRoleLimit", ()=>enforceRoleLimit);
var _memberhandling = require("./memberhandling");
var _taskshandling = require("./taskshandling");
var _databasehandling = require("./databasehandling");
//-----------------------
const memberHandler = new (0, _memberhandling.MemberHandler)();
const taskHandler = new (0, _taskshandling.TaskHandler)();
function setupDropdown(dropdownId) {
    ...
    inputs.forEach((input)=>{
        ...
        inputElement.addEventListener("change", ()=>{
            if (inputElement.type === "radio") dropdown.classList.remove("active");
        });
    });
}
function setupFormValidation(formId) {
    ...
    form.addEventListener("submit", (event)=>{
        const memberInput = form.querySelector("#member-name");
...
function setupAssignMenu() {
    ...
    if (assignButton && assignMenu) {
        ...
        document.addEventListener("click", (event)=>{
            if (!assignButton.contains(event.target) && !assignMenu.contains(event.target)) {
...
function setupOptionsMenu() {
    ...
    document.addEventListener("click", (event)=>{
        if (!optionsBtn.contains(event.target) && !optionsMenu.contains(event.target)) optionsMenu.classList.remove("show");
    });
}
function setupFormSubmission() {
    ...
    form.addEventListener("submit", (event)=>{
        ...
        const selectedCategoryInput = categoryDropdown.querySelector("input[type='radio']:checked");
...
function getSelectedDropdownValues(dropdown) {
...
function setupResetButton() {
    ...
    resetButton.addEventListener("click", ()=>{
        ...
        if (confirmReset) (0, _databasehandling.clearDatabase)();
    });
}
...
function updateTasksUI(tasks) {
    ...
    tasks.forEach((task)=>{
        ...
        taskText.innerHTML = `
            ...
            ${task.status === "done" ? `<br> <em class="task-status">Completed:</em> <span class="task-timestamp">${task.timestampDone ? new Date(task.timestampDone).toLocaleString() : "Unknown"}</span>` : `<br> <em class="task-status">Added:</em> <span class="task-timestamp">${task.timestamp ? new Date(task.timestamp).toLocaleString() : "Unknown"}</span>`}`;
        taskItem.appendChild(checkbox);
        taskItem.appendChild(taskText);
        if (task.status === "done") doneColumn.appendChild(taskItem);
        else if (task.status === "in progress") ongoingColumn.appendChild(taskItem);
        else toDoColumn.appendChild(taskItem);
    });
}
function setupDeleteButton() {
    ...
    deleteButton.addEventListener("click", ()=>{
        const selectedTasks = Array.from(document.querySelectorAll("#done-list input[type='checkbox']:checked")).map((checkbox)=>{
...
function setupDoneButton() {
    ...
    doneButton.addEventListener("click", ()=>{
        const selectedTasks = Array.from(document.querySelectorAll("#ongoing-list input[type='checkbox']:checked")).map((checkbox)=>checkbox.parentElement?.dataset.taskId).filter((taskId)=>!!taskId);
        if (selectedTasks.length === 0) {
            alert("Please select a task to mark as Done.");
            return;
        }
        selectedTasks.forEach((taskId)=>{
            taskHandler.markTaskAsDone(taskId, ()=>{}, (error)=>console.error("Error moving task to Done:", error));
        });
    });
}
function assignSelectedTaskToMember(memberId, memberName) {
    const selectedTasks = Array.from(document.querySelectorAll("#todo-list input[type='checkbox']:checked")).map((checkbox)=>checkbox.parentElement?.dataset.taskId).filter((taskId)=>!!taskId);
    if (selectedTasks.length === 0) {
...
function setupFiltering() {
    ...
    const categoryFilterSelect = document.getElementById("filter-by-category");
    const memberFilterSelect = document.getElementById("filter-members");
...
function filterTasks(tasks, sortBy, categoryFilter, memberFilter) {
    let filteredTasks = [
        ...tasks
    ];
    if (categoryFilter !== "all") filteredTasks = filteredTasks.filter((task)=>{
    ...
    if (memberFilter !== "all") filteredTasks = filteredTasks.filter((task)=>task.assigned === memberFilter);
    if (sortBy === "az") filteredTasks.sort((a, b)=>a.title.localeCompare(b.title));
    else if (sortBy === "za") filteredTasks.sort((a, b)=>b.title.localeCompare(a.title));
    else if (sortBy === "newest") filteredTasks.sort((a, b)=>(b.timestamp ? new Date(b.timestamp).getTime() : 0) - (a.timestamp ? new Date(a.timestamp).getTime() : 0));
    else if (sortBy === "oldest") filteredTasks.sort((a, b)=>(a.timestamp ? new Date(a.timestamp).getTime() : 0) - (b.timestamp ? new Date(b.timestamp).getTime() : 0));
    return filteredTasks;
}
function setupDynamicFilters() {
    const filterMembersDropdown = document.getElementById("filter-members");
...
function setupCategoryFilter(tasks) {
    const categoryFilterSelect = document.getElementById("filter-by-category");
    ...
    tasks.forEach((task)=>{
        ...
        if (typeof category === "string") uniqueCategories.add(category.trim().toLowerCase());
    });
...
function enforceRoleLimit() {
    const roleCheckboxes = document.querySelectorAll("#role-dropdown input[type='checkbox']");
...
},{"./memberhandling":"5TK2Q","./taskshandling":"brsxg","./databasehandling":"8rK7Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5TK2Q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "MemberHandler", ()=>MemberHandler);
var _database = require("firebase/database");
var _firebase = require("./firebase");
class MemberHandler {
    addMember(name, roles) {
        if (roles.length > 3) {
            alert("You can only assign up to 3 roles per member.");
            return;
        }
        const newMemberRef = (0, _database.push)(this.membersRef);
        (0, _database.set)(newMemberRef, {
            name,
            roles
        }).catch((error)=>console.error("Error adding member:", error));
    }
    listenForMembers(updateUI) {
        (0, _database.onValue)(this.membersRef, (snapshot)=>{
            const data = snapshot.val();
            const membersList = data ? Object.keys(data).map((id)=>({
                    id,
                    name: data[id].name,
                    roles: data[id].roles || []
                })) : [];
    ...
    constructor(){
        this.membersRef = (0, _database.ref)((0, _firebase.db), "members");
    }
}

},{"firebase/database":"SJ4UY","./firebase":"2cuXI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"brsxg":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TaskHandler", ()=>TaskHandler) // import { ref, push, set, update, remove, onValue, get } from "firebase/database";
...
class TaskHandler {
    addTask(title, description, category) {
        const newTaskRef = (0, _database.push)(this.tasksRef);
        (0, _database.set)(newTaskRef, {
            title,
            description,
            category,
            status: "new",
    ...
    listenForTasks(callback) {
        (0, _database.onValue)(this.tasksRef, (snapshot)=>{
            const tasks = snapshot.val();
            if (tasks) {
    ...
    moveTask(taskId, currentStatus) {
        const taskRef = (0, _database.ref)((0, _firebase.db), `assignments/${taskId}`);
        const newStatus = currentStatus === "new" ? "in progress" : "done";
        (0, _database.update)(taskRef, {
            status: newStatus
        }).catch((error)=>console.error("Error moving task:", error));
    }
    deleteTask(taskId, onSuccess, onError) {
        const taskRef = (0, _database.ref)((0, _firebase.db), `assignments/${taskId}`);
        (0, _database.remove)(taskRef).then(()=>{
            if (onSuccess) onSuccess();
        }).catch((error)=>{
            console.error("\u274C Error deleting task:", error);
            if (onError) onError(error);
    ...
    markTaskAsDone(taskId, onSuccess, onError) {
        const taskRef = (0, _database.ref)((0, _firebase.db), `assignments/${taskId}`);
        (0, _database.update)(taskRef, {
            status: "done",
            timestampDone: new Date().toISOString()
    ...
    async assignTaskToMember(taskId, memberName, onSuccess, onError) {
        try {
            const taskRef = (0, _database.ref)((0, _firebase.db), `assignments/${taskId}`);
            let taskData;
            await new Promise((resolve, reject)=>{
                (0, _database.onValue)(taskRef, (snapshot)=>{
                    taskData = snapshot.val();
                    resolve();
                }, {
                    onlyOnce: true
            ...
            // Normalize task categories
            const taskCategories = Array.isArray(taskData.category) ? taskData.category.map((c)=>c.toLowerCase().trim()) : [
                taskData.category.toLowerCase().trim()
            ];
            // Fetch members
            ...
            // Normalize member roles
            const memberRoles = Array.isArray(member.roles) ? member.roles.map((r)=>r.toLowerCase().trim()) : [
                member.roles.toLowerCase().trim()
            ];
            // Check for role match
            const roleMatch = memberRoles.some((role)=>taskCategories.includes(role));
    ...
    constructor(){
        this.tasksRef = (0, _database.ref)((0, _firebase.db), "assignments");
        this.memberHandler = new (0, _memberhandling.MemberHandler)();
    }
}

},{"firebase/database":"SJ4UY","./firebase":"2cuXI","./memberhandling":"5TK2Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8rK7Q":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function clearDatabase() {
    const dbRef = (0, _database.ref)((0, _firebase.db), "/");
    (0, _database.remove)(dbRef).catch((error)=>console.error("Error clearing database:", error));
}

},{"firebase/database":"SJ4UY","./firebase":"2cuXI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ggIi6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addLog", ()=>addLog);
parcelHelpers.export(exports, "startTaskLogging", ()=>startTaskLogging);
parcelHelpers.export(exports, "startMemberLogging", ()=>startMemberLogging);
parcelHelpers.export(exports, "startLogging", ()=>startLogging);
var _database = require("firebase/database");
var _firebase = require("./firebase");
...
function startTaskLogging() {
    const tasksRef = (0, _database.ref)((0, _firebase.db), "assignments");
    (0, _database.onChildAdded)(tasksRef, (snapshot)=>{
        const task = snapshot.val();
        addLog(`Task "${task.title}" was added`);
    });
    (0, _database.onChildChanged)(tasksRef, (snapshot)=>{
        const task = snapshot.val();
        if (task.status === "done") addLog(`Task "${task.title}" marked as Done`);
        else if (task.assigned) addLog(`Task "${task.title}" assigned to ${task.assigned}`);
        else addLog(`Task "${task.title}" was updated`);
    });
    (0, _database.onChildRemoved)(tasksRef, (snapshot)=>{
        const task = snapshot.val();
        addLog(`Task "${task.title}" deleted`);
    });
}
function startMemberLogging() {
    const membersRef = (0, _database.ref)((0, _firebase.db), "members");
    (0, _database.onChildAdded)(membersRef, (snapshot)=>{
    ...
    (0, _database.onChildChanged)(membersRef, (snapshot)=>{
        const member = snapshot.val();
        const roles = Array.isArray(member.role) ? member.role : [
            member.role
        ];
    ...
    (0, _database.onChildRemoved)(membersRef, (snapshot)=>{
        const member = snapshot.val();
...
},{"firebase/database":"SJ4UY","./firebase":"2cuXI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cAPdp","jeorp"], "jeorp", "parcelRequire94c2")
